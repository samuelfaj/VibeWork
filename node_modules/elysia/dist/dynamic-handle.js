...
const injectDefaultValues = (typeChecker, obj) => {
  ...
  return async (context, error) => {
    ...
    if (errorContext.set = context.set, typeof error?.toResponse == "function" && !(error instanceof import_error.ValidationError) && !(error instanceof import_value.TransformDecodeError))
      try {
