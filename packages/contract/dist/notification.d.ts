...
export declare const NotificationTypeSchema: import('@sinclair/typebox').TUnion<
  [import('@sinclair/typebox').TLiteral<'in-app'>, import('@sinclair/typebox').TLiteral<'email'>]
>
